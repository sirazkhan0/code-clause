...
root.title("Calculator By siraz")

switch = None

def about_me():
    tmsg.showinfo('About Me','Myself siraz')
def Help():
    tmsg.showinfo("help",("https://www.linkedin.com/in/sirazkhan1/"))
my_menu = Menu(root)
...
m2 = Menu(my_menu, tearoff=0, fg='blue')
m2.add_command(label = 'Help', command = Help)
root.config(menu=my_menu)
my_menu.add_cascade(label='Help', menu=m2)
# Button on press
